...
//        System.out.println("Amount of information in \"" + name + "\": " + countMessageAmountOfInfo(name, analyzer.getAlphabetTable()));
...
//
//
//    public static double countMessageAmountOfInfo(String message, Map<Character, LetterInfo> table){
//        double result = 0.0;
